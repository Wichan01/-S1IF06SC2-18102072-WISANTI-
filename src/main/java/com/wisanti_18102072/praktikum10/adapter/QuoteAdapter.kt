package com.wisanti_18102072.praktikum10.adapter
...
import com.wisanti_18102072.praktikum10.QuoteAddUpdateActivity
import com.wisanti_18102072.praktikum10.R
import com.wisanti_18102072.praktikum10.data.Quote
import com.wisanti_18102072.praktikum10.databinding.ItemQuoteBinding
import com.wisanti_18102072.praktikum10.helper.EXTRA_POSITION
import com.wisanti_18102072.praktikum10.helper.EXTRA_QUOTE
import com.wisanti_18102072.praktikum10.helper.REQUEST_UPDATE
...
class QuoteAdapter(private val activity: Activity): RecyclerView.Adapter<QuoteAdapter.QuoteViewHolder>() {
    ...
    inner class QuoteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(quote: Quote, position: Int) {
            ...
            //binding.tvItemDescription.text = quote.medsos
            binding.tvItemDate.text = quote.date
           //binding.tvItemDescription.text = quote.number
