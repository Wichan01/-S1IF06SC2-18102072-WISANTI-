package com.wisanti_18102072.praktikum14.api
...
import com.wisanti_18102072.praktikum14.model.Message
import com.wisanti_18102072.praktikum14.model.QuoteResponse
import com.wisanti_18102072.praktikum14.ui.globalquotes.GlobalQuotesFragment
...
class MainPresenter(private val view: MainView, private val context: CoroutineContextProvider = CoroutineContextProvider()) {
    ...
    fun getMyQuotes(token:String?) {
        GlobalScope.launch (context.main){
            try {
                ApiMain().services.getMyQuotes("Bearer "+token).enqueue(object : Callback<QuoteResponse> {
